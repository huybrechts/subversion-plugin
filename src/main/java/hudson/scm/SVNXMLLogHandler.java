...
public class SVNXMLLogHandler extends AbstractXMLHandler implements ISVNLogEntryHandler {
    ...
    public static final String REPOSITORY_ROOT_TAG = "repository-root";
    ...
    private void sendToHandler(SVNLogEntry logEntry) throws SAXException {
        ...
        if (repositoryRootUrl != null) {
        	addTag(REPOSITORY_ROOT_TAG, repositoryRootUrl);
        }
	...
	public void setCurrentRepositoryRootUrl(String repositoryRootUrl) {
